...
function createDatabase(PIWebAPIUrl, AssetServer, Name, Password, AuthType) {
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      var urlCreateAFSampleDatabase =
        response['Links']['Self'] + '/assetdatabases';
      data = {
        Name: databaseName,
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          console.log(
            (response === undefined || response === ''
              ...
              ' OSIjQueryDatabase database created'
          );
...
function createCategory(PIWebAPIUrl, AssetServer, Name, Password, AuthType) {
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      data = { Name: categoryName, Description: 'Sample machine category' };
      $('#txtAPI').val(
        $('#txtAPI').val() + '\n\nCreate category:\n' + urlCreateCategory
      );
      $('#txtAPI').val(
      ...
      $.ajax({
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          console.log(
            (response === undefined || response === ''
              ? ''
              : JSON.stringify(response)) + ' sampleMachine category created'
          );
          statusCode = jqXHR.status;
        },
        error: function (error) {
...
function createTemplate(
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      var urlCreateElementTemplate =
        response['Links']['Self'] + '/ElementTemplates';
      var data = {
        Name: templateName,
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          console.log(
            (response === undefined || response === ''
              ? ''
              : JSON.stringify(response)) +
              ' Template OSIjQueryTemplate created'
          );
          // Find the created template
          var urlFindMachineTemplate =
            PIWebAPIUrl +
          ...
          $.ajax({
            ...
            success: function (response, textStatus, jqXHR) {
              ...
              createTemplateAttributeActive(
                response['Links']['Self'] + '/attributetemplates',
                PIServer,
                Name,
                Password,
                AuthType
            ...
            error: function (error) {
              ...
              statusCode = errorHandler(
                'Error finding created template: ',
                error
              );
            },
          });
 ...
 * @param {*} AuthType string: Authorization type:  basic or kerberos
 */
function createTemplateAttributeActive(
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      createTemplateAttributeSinusoid(
        urlTemplateAttributes,
        PIServer,
        Name,
        Password,
 ...
 * @param {*} AuthType string: Authorization type:  basic or kerberos
 */
function createTemplateAttributeSinusoid(
  urlTemplateAttributes,
  PIServer,
  Name,
  Password,
  ...
  $.ajax({
    ...
    data: JSON.stringify(data),
    success: createTemplateAttributeSampleTag(
      urlTemplateAttributes,
      PIServer,
      Name,
      Password,
    ...
    error: function (error) {
      // Error creating the attribute
      statusCode = errorHandler(
        'Error creating OSIjQueryAttributeSinusoid attribute: ',
        error
      );
    },
  });
 ...
 * @param {*} AuthType string: Authorization type:  basic or kerberos
 */
function createTemplateAttributeSampleTag(
  urlTemplateAttributes,
  PIServer,
  Name,
  Password,
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          $.ajax({
            ...
            success: function (response, textStatus, jqXHR) {
              ...
              var urlCreateElementAttributeReferences =
                PIWebAPIUrl + '/elements/' + response['WebId'] + '/config';
              ...
              $.ajax({
                ...
                success: function (response, textStatus, jqXHR) {
                  ...
                  console.log(
                    'Created the tag references based on the template configuration'
                  );
                  statusCode = jqXHR.status;
                },
                error: function (error) {
                  ...
                  statusCode = errorHandler(
                    'Error creating element tag references: ',
                    error
                  );
                },
              });
...
function writeSingleValue(PIWebAPIUrl, AssetServer, Name, Password, AuthType) {
  ...
  var urlFindElementAttributeSampleTag =
    PIWebAPIUrl +
    '/attributes?path=\\\\' +
    AssetServer +
    '\\' +
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      $.ajax({
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          console.log(
            'Attribute OSIjQueryAttributeSampleTag write value ' +
              attributeValue
          );
...
function writeDataSet(PIWebAPIUrl, AssetServer, Name, Password, AuthType) {
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      var urlWriteSampleTagValues =
        PIWebAPIUrl + '/streams/' + response['WebId'] + '/recorded';
      $('#txtAPI').val(
      ...
      $.ajax({
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          console.log(
            'Attribute OSIjQueryAttributeSampleTag streamed 100 values'
          );
          $('#txtResult').val('Returned status ' + jqXHR.status + '\n');
          statusCode = jqXHR.status;
        },
 ...
 * @param {*} AuthType string: Authorization type:  basic or kerberos
 */
function readAttributeSnapshot(
  PIWebAPIUrl,
  AssetServer,
  Name,
  Password,
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      var urlGetSampleTagValue =
        PIWebAPIUrl + '/streams/' + response['WebId'] + '/value';
      $('#txtAPI').val(
      ...
      $.ajax({
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          console.log(
            'Attribute OSIjQueryAttributeSampleTag snapshot value ' +
              response.Value
          );
          statusCode = jqXHR.status;
        },
 ...
 * @param {*} AuthType string: Authorization type:  basic or kerberos
 */
function readAttributeSelectedFields(
  PIWebAPIUrl,
  AssetServer,
  Name,
  Password,
...
function doBatchCall(PIWebAPIUrl, AssetServer, Name, Password, AuthType) {
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      $('#txtResult').val(
        $('#txtResult').val() + 'Status: ' + response[1].Status
      );
      ...
      $('#txtResult').val(
        $('#txtResult').val() + 'Status: ' + response[4].Status
      );
      ...
      $('#txtResult').val(
        $('#txtResult').val() + 'Status: ' + response[5].Status
      );
...
function deleteTemplate(PIWebAPIUrl, AssetServer, Name, Password, AuthType) {
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      $.ajax({
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          $('#txtResult').val('Returned status ' + jqXHR.status + '\n');
          console.log(
            (response === undefined ? '' : JSON.stringify(response)) +
              ' Template OSIjQueryTemplate deleted'
          );
          statusCode = jqXHR.status;
        },
        error: function (error) {
    ...
    error: function (error) {
      ...
      $('#txtResult').val(
        'Error finding template: ' + error.responseText + '\n'
      );
      console.log(error.responseText);
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      $.ajax({
        ...
        success: function (response, textStatus, jqXHR) {
          ...
          console.log(
            (response === undefined ? '' : JSON.stringify(response)) +
              ' Category OSIjQueryCategory deleted'
          );
          statusCode = jqXHR.status;
        },
        error: function (error) {
...
function deleteDatabase(PIWebAPIUrl, AssetServer, Name, Password, AuthType) {
  ...
  $.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      var urlDeleteSampleDatabase =
        PIWebAPIUrl + '/assetdatabases/' + response['WebId'];
      $('#txtAPI').val(
